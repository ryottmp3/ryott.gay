...
BLOG_AUTHOR = "H Ryott Glayzer"  # (translatable)
BLOG_TITLE = "Ryott's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ryott.gay/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ryott.gay/"
BLOG_EMAIL = "ryott@ryott.gay"
BLOG_DESCRIPTION = "The place where physics and music play"  # (translatable)
